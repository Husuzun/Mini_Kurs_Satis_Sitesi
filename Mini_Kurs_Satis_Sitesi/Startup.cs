    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ApplicationDbContext>(options =>
            {
                ...
                {
                    sqlOptions.MigrationsAssembly("Mini_Kurrs_Satis_Sitesi.Data");
                });
            });
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Mini_Kurrs_Satis_Sitesi", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Mini_Kurrs_Satis_Sitesi v1"));
            }
            else
            {
            }
